        ...
        >
          {step === 'confirm' && (
            <>
              <DialogHeader>
                <DialogTitle>
                  {t('export_knowledge_base_confirm_title')}
                </DialogTitle>
                <DialogDescription>
          ...
          {step === 'processing' && (
            <>
              <DialogHeader>
                <DialogTitle>
                  {t('export_knowledge_base_processing_title')}
                </DialogTitle>
                <DialogDescription>
                  {taskStatus?.message ?? '...'}
                </DialogDescription>
          ...
          {step === 'completed' && (
            <>
              <DialogHeader>
                <DialogTitle>
                  {t('export_knowledge_base_completed_title')}
                </DialogTitle>
                <DialogDescription>
          ...
          {step === 'failed' && (
            <>
              <DialogHeader>
                <DialogTitle>
                  {t('export_knowledge_base_failed_title')}
                </DialogTitle>
                <DialogDescription>
