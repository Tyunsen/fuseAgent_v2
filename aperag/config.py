...
class Config(BaseSettings):
    ...
    # Neo4j / MiroFish graph build
    neo4j_uri: Optional[str] = Field(None, alias="NEO4J_URI")
    neo4j_host: str = Field("127.0.0.1", alias="NEO4J_HOST")
    ...
    mirofish_graph_chunk_size: int = Field(3200, alias="GRAPH_DEFAULT_CHUNK_SIZE")
    mirofish_graph_chunk_overlap: int = Field(240, alias="GRAPH_DEFAULT_CHUNK_OVERLAP")
