...
class GraphService:
    ...
    async def get_graph_labels(self, user_id: str, collection_id: str) -> view_models.GraphLabelsResponse:
        ...
        if is_mirofish_collection_config(view_collection.config):
            return await mirofish_graph_service.get_graph_labels(user_id, collection_id)
    ...
    async def get_knowledge_graph(
        ...
        if is_mirofish_collection_config(view_collection.config):
            return await mirofish_graph_service.get_knowledge_graph(
                user_id,
                collection_id,
                label=label or "*",
                max_nodes=max_nodes,
